 ...
 * 
 * @see com.kstrata.apps.tsm.business.dao.entity.Role
 * @author MyEclipse Persistence Tools
 */
@SuppressWarnings({"rawtypes"})
public class RoleDAOImpl extends BaseDao implements RoleDAO, Serializable {
	/**
	 * 
	 */
	...
	public Role findById(java.lang.Integer id) {
		...
		try {
			Role instance = (Role) super.getSession().get("com.kstrata.apps.tsm.business.dao.entity.Role", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Role instance) {
		...
		try {
			List results = super.getSession().createCriteria("com.kstrata.apps.tsm.business.dao.entity.Role")
	...
	public Role merge(Role detachedInstance) {
		...
		try {
			Role result = (Role) super.getSession().merge(detachedInstance);
